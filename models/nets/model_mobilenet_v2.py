...
# 将环境变量 CUDA_LAUNCH_BLOCKING 设置为 1，
# 以确保 CUDA kernel 的调用是同步的，
# 这样就可以在错误发生时获取正确的堆栈跟踪信息
...
class MobileNetV2(nn.Module):
    def __init__(self, cfg, width_mult=1., dropout_ratio=0.2, use_batch_norm=True, onnx_compatible=False):
        ...
        assert cfg['MODEL']['TARGET_TYPE'] in ["gaussian", "offset"]
        ...
        # 根据给定的 width_mult 缩放输入通道数和最后输出通道数。
